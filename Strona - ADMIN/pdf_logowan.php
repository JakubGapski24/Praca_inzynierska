...
$dane = $_SESSION['dane']; //ustaw dane do wstawienia do pliku
...
$pdf->Output('Logowania '.$data_generacji.' .pdf', 'I'); //ustaw nazwę pliku na podaną z uwzględnieniem daty generacji pliku
?>